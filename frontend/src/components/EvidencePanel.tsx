        ...
        {categories.map((cat) => (
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              border: selectedCategory === cat ? '1px solid #7C3AED' : '1px solid var(--border-subtle)',
              background: selectedCategory === cat ? 'rgba(124, 58, 237, 0.08)' : 'var(--bg-panel)',
              color: selectedCategory === cat ? '#7C3AED' : 'var(--text-secondary)',
